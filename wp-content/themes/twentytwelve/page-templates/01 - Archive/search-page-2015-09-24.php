...
<!-- (1) search -->
				...
				<div style="border: 2px solid #323232;height:100%;margin-top:77px;">
					<?php echo GeoMashup::map('map_type=G_SATELLITE_MAP&height=100%&width=100%&zoom=5&marker_select_info_window=true&marker_select_center=false&map_content=global'); ?>
				</div>
			</div>
		</div>
	</body>
