<?php
/**
 * Template Name: Wiki Page Template
 *
...
<!-- (2) Search -->
				...
				<div style="padding-top:79px;" id="primary" class="site-content">
					<div id="content" role="main" class="single-content">
						<?php while ( have_posts() ) : the_post(); ?>
							<iframe style="width:100%; height:100vh;" src="https://github.com/rhaubt/Rock-Art-Database-RADB-/wiki">
