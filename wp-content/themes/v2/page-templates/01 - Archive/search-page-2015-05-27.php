				...
				<table style="width:100%;">
					...
					<tr>
						<td style="border: 2px solid #323232;">
							<?php echo GeoMashup::map('map_type=G_PHYSICAL_MAP&height=450&width=100%&zoom=2&marker_select_info_window=true&marker_select_center=false&map_content=global'); ?>
						</td>
					</tr>
					<tr>
