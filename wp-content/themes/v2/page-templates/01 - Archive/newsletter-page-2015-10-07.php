...
/* ----- General ----- */
.site-content {
	background-image: url("http://rockartdatabase.com/v2/wp-content/themes/v2/wp-content/images/main_menu_about_sulawesi.jpg");
...
<!-- Index -->						
						<h2>Newsletters and Publications</h2></br></br>
						This catalogues contains a list of rock-art newsletters, journals and other publications from the collection entries. To sign up for news letters please see the individual websites for details.</br></br>
						<ol>
						<li><a style="text-decoration:none;" title="got to ..." href="#newsletter">--></a> Newsletters, Journals and Other Frequent Publications</li>
						<li><a style="text-decoration:none;" title="got to ..." href="#publication">--></a> List of Rock-Art Publications</li>
						</ol></br></br>	
<!-- Newsletter Section -->
						<a name="newsletter"></a><h2>- - - - - - - - - - - - - - - - - - - Rock-Art Related Newsletters & Journals - - - - - - - - - - - - - - - - - - -</h2></br></br>					
							<?php $newsletter = new WP_Query(
    						array(
        					'post_type' => array('cpt-00-01', 'cpt-01-01', 'cpt-01-02'),
        					'orderby' => 'title',
        					'post_status' => 'publish',
    						)
							);
							...
							<?php if($newsletter->have_posts()) : ?>
    							<?php while($newsletter->have_posts()) : $newsletter->the_post(); ?>
        							<div><?php if (get_field('RAE_0234_r')): ?>
											<?php while(has_sub_field('RAE_0234_r')): ?>
												<div>
															<p class="custom_small-font" style="text-decoration:none;">
																<span class="dashicons dashicons-media-document" style="font-size:12px;"></span> <a style="text-decoration:none;" class="lightbox" target="_blank" href="<?php the_sub_field('RAE_0235')?>"> <?php the_sub_field('RAE_0234')?></a> </br>  
...
<!-- Publication Section -->
						...
						<a name="publication">- - - - - </a></br></br></br></br></br></br></br></br><a href="#newsletter">back to top</a>
						<h1>- - - - - - - - - - - - - - - - - - - - - - - - - - - - Other Publications - - - - - - - - - - - - - - - - - - - - - - - - - - - - </h1></br></br>
							<?php $reference = new WP_Query(
    						array(
        					'post_type' => array('cpt-00-01', 'cpt-01-01', 'cpt-01-02'),
        					'orderby' => 'title',
        					'post_status' => 'publish',
							...
							<?php if($reference->have_posts()) : ?>
    							<?php while($reference->have_posts()) : $reference->the_post(); ?>
        							<div><?php if (get_field('RAE_0089_r')): ?>
											<?php while(has_sub_field('RAE_0089_r')): ?>
												<div>
															<p class="custom_small-font">
																<span class="dashicons dashicons-media-document" style="font-size:12px;"></span><a style="text-decoration:none;" class="lightbox" target="_blank" href="<?php the_sub_field('RAE_0187')?>"> <?php the_sub_field('RAE_0089')?>, <?php the_sub_field('RAE_0186')?></a> </br>  
																<small>Published in <?php the_field('RAE_0003') ?> <a style="text-decoration:none;" target="_blank" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>" rel="bookmark"><?php the_title(); ?></a></small>
															</p><hr>
												</div>
										<?php endwhile; ?>
