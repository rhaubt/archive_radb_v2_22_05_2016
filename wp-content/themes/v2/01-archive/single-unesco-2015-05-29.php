...
<div id="primary" class="site-content">
	<div id="content" role="main">
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<div style="width: 100%; height: 36px; background-color: #191e23; padding: 10px 0px 0px 10px; color: #e0e0e0;">
				<h2><a target="_top" href="http://www.rockartdatabase.com/v2"><small>back to</small></a>     Rock Art Database</h2>
			</div>
...
<!--     Available Media -->
				<div class="ac-container">
					...
					<label for="ac-3"><span class="dashicons dashicons-admin-media" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span> Media (<?php $count = (count(get_field('RAE_0208_r'))+count(get_field('RAE_0212_r'))+count(get_field('RAE_0219_r'))+count(get_field('RAE_0223_r'))+count(get_field('RAE_0227_r'))+count(get_field('RAE_0242_r'))); ?><?php echo $count ?>)</label>
...
<!-- (4) Social Media -->
				<div>
					...
					<label for="ac-4"><span class="dashicons dashicons-share" style="position: relative; top: 7px; left: 0px; z-index: 5;"></span> Social Media (<?php $count = (count(get_field('RAE_0234_r'))+count(get_field('RAE_0237_r'))); ?><?php echo $count ?>)</label>
					<article class="ac-large">
					<div style="width:100%; height:27px;">place holder
					</div>
<!--     Total -->					
					<table class="custom-table-style">
						<tr>
							<td class="custom-td-bg_2">
								<p>Total: <small style="font-weight: lighter;"> <span class="dashicons dashicons-media-document" style="position: relative; top: 7px; left: 0px; z-index: 5;"></span> <?php $count = count(get_field('RAE_0234_r')); ?><?php echo $count ?> | <span class="dashicons dashicons-groups" style="position: relative; top: 7px; left: 0px; z-index: 5;"></span> <?php $count = count(get_field('RAE_0237_r')); ?><?php echo $count ?></small></p>
							</td>
						</tr>
					</table>
<!--     Social Media -->					
...
<!--     GPS -->
					<table class="custom-table-style">
							<tr>
								<td class="custom-td-bg_1">
           							<p class="custom_small-font"><span class="dashicons dashicons-admin-post" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span> GPS: <?php the_field('RAE_0104')?></p>
           						</td>
           						<td class="custom-td-bg_1">
...
<!-- Media Gallery -->	
				<div style="width: 150px; height: 588px; float: left; background-color:#e0e0e0; overflow: scroll;">
<!--     images -->
           						<div class="custom-media-image">
										<?php if (get_field('RAE_0208_r')): ?><?php $counter = 1; ?>
															...
															<?php while(has_sub_field('RAE_0208_r')): ?>
																<div class="custom-div-bg_1">																	
																	<div id="media-gallery-background"><a class="lightbox1" title="<strong><?php the_sub_field('RAE_0210')?>:</strong> <?php the_sub_field('RAE_0211')?>" href="<?php the_sub_field('RAE_0209')?>"><img class="media-gallery" src="<?php the_sub_field('RAE_0209')?>"></a>
																	</div>
           						...
           						<div class="custom-media-image">
										<?php if (get_field('RAE_0223_r')): ?><?php $counter = 1; ?>
															...
															<?php while(has_sub_field('RAE_0223_r')): ?>
																<div class="custom-div-bg_1">																
																	<div id="media-gallery-background"><a class="lightbox" title="<strong><?php the_sub_field('RAE_0224')?>:</strong> <?php the_sub_field('RAE_0225')?>" rel="lightbox[x3d]" href="<?php the_sub_field('RAE_0226')?>"><img class="media-gallery" src="<?php the_sub_field('RAE_0223')?>"></a>
																	</div>
           						...
           						<div class="custom-media-image">
										<?php if (get_field('RAE_0227_r')): ?><?php $counter = 1; ?>
															...
															<?php while(has_sub_field('RAE_0227_r')): ?>
																<div class="custom-div-bg_1">																	
																	<div id="media-gallery-background"><a class="lightbox" title="<strong><?php the_sub_field('RAE_0228')?>:</strong> <?php the_sub_field('RAE_0229')?>" rel="lightbox[earth]" href="<?php the_sub_field('RAE_0230')?>"><img class="media-gallery" src="<?php the_sub_field('RAE_0227')?>"></a>
																	</div>
