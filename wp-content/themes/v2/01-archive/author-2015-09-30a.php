...
<!--     Online Presence  -->
						...
						<span title="find us on social media eg website, twitter, academia, facebook etc." class="dashicons dashicons-share" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span>
							...
							<a style="text-decoration:none;" target="_blank" href="<?php echo $curauth->facebook; ?>"><span class="dashicons dashicons-facebook" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span></a>
							<?php endif; ?>
							<?php if ($curauth->twitter): ?>
							<a style="text-decoration:none;" target="_blank" href="<?php echo $curauth->twitter; ?>"><span class="dashicons dashicons-twitter" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span></a>
							<?php endif; ?>
							<?php if ($curauth->linkedin): ?>
							<a style="text-decoration:none;" target="_blank" href="<?php echo $curauth->linkedin; ?>">LinkedIn</a>
							<?php endif; ?>
							<?php if ($curauth->academia): ?>
							<a style="text-decoration:none;" target="_blank" href="<?php echo $curauth->academia; ?>">Academia</a>
							<?php endif; ?>
							<?php if ($curauth->user_url): ?>
							<a style="text-decoration:none;" target="_blank" href="<?php echo $curauth->user_url; ?>">Web</a>
							<?php endif; ?></br></br>					
