...
<!--     author  -->						
						<p style="padding:5px 0px 0px 0px;"class="custom_small-font"><?php echo get_avatar( get_the_author_meta( 'ID' ), 30 ); ?> Author: <?php echo get_the_author(); ?> <?php the_author_posts_link(); ?></p>
