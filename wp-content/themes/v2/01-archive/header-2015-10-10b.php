...
<link rel=author href="<?php the_author_url(); ?>" />
...
<meta name="DC.publisher" content="<?php the_author_meta( 'last_name', 'first_name' ); ?>">
<meta name="DC.creator" content="<?php the_author_meta( 'last_name', 'first_name' ); ?>">
