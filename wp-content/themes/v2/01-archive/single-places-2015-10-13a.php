...
<!-- (TAB 1 INFO) title name  -->						
						<h1 class="custom_headingalign" style="font-size:14px;"><?php foreach((get_the_category()) as $category) { echo $category->cat_name . ' '; } ?>: <?php the_field('RAE_0003') ?></h1></br>
