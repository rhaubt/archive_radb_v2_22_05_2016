...
<!--     category and ID  -->			
			<div style="width: 460px; height: 36px; background-color: #191e23; padding: 0px 0px 0px 0px; color: #e0e0e0; position:fixed; z-index:10;">
				<h2 style="padding: 8px;"><?php foreach((get_the_category()) as $category) { echo $category->cat_name . ' '; } ?> | ID: <a target="_blank" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
			</div>
...
<!-- Feature Image Thumbnail and Lightbox -->				
					...
					$height = $image['sizes'][ $size_large . '-height' ];
 					?>
					<a target="_blank" href="<?php the_permalink() ?>" title="open this entry in new window"><img style="border-radius: 5px;" src="<?php echo $thumb; ?>" alt="no image"></a>
					</td>
<!--     color label  -->
...
<!--     author  -->						
						<p style="padding:5px 0px 0px 0px;"class="custom_small-font"><?php echo get_avatar( get_the_author_meta( 'ID' ), 30 ); ?> Author: <?php the_author_posts_link(); ?></p></br>
<!--     entry date  -->						
						...
						?> | Last Update <?php echo get_the_date(); ?></p>			
<!--     condition  -->						
						<p class="custom_small-font">Condition: <?php the_field('RAE_0082'); ?></br></br>
...
<!-- (1) info description -->				
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_1"><span title="contains a description about this entry" class="dashicons dashicons-admin-home" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Info <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<?php if (get_field('RAE_0200_r')): ?>					
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_2"><span title="if entry has flags it may indicate that this entry needs attention" class="dashicons dashicons-flag" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Flag <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<?php endif; ?>
<!-- (3) Conservation -->				
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_3"><span class="dashicons dashicons-star-empty" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Conservation <span style="float:right; padding-right:5px;">&#9660</span></label>
  			...
  			<div style="background-color:#eeeeee; padding:2px;">
  						<table class="custom-table-style">
           					<tr>
								<td class="custom-td-bg_2">
									<p class="custom_small-font">												
										Condition: <?php the_field('RAE_0082'); ?>																			
									</p>
								</td>
							</tr>
						</table>
						<table class="custom-table-style">
           					<tr>
								<td class="custom-td-bg_2">
									<p class="custom_small-font">												
										Issues: <?php the_field('RAE_0033'); ?></br>Description: <?php the_field('RAE_0034'); ?>																	
									</p>
								</td>
							</tr>
						</table>
...
<!-- (4) Location -->	
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_4"><span title="the geolocation of this record including address and or location approach descriptions" class="dashicons dashicons-location-alt" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Location <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (5) Collection Location (other collections within this archives) -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_5"><span title="all continents, countries, regions or language group areas contained within this entry (if the entry is a place, site or item the location usually only contains one continent, country or region)" class="dashicons dashicons-archive" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Collection Locations (<?php $count = (count(get_field('RAE_0118'))); ?><?php echo $count ?> continents) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- Show Own Relationship Field Selections -->									
										<?php 
...
<!-- Show Reverse Query Relationship Field (In which posts is this post selected) -->									
										<?php 
										/*
...
<!-- (7) classification archaeology -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_7"><span title="entry classifications by archaeological means in accordance with CIDOC CRM, MIDAS Heritage, SEWPAC, Rock Art Stability Index and PERAHU Rock Art recording forms" class="dashicons dashicons-clipboard" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Classification (Archaeology) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (8) classification rock art -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_8"><span title="entry classifications by rock art research means in accordance with CIDOC CRM, MIDAS Heritage, SEWPAC, Rock Art Stability Index and PERAHU Rock Art recording forms" class="dashicons dashicons-universal-access-alt" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Classification (Rock Art) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (9) Measurment -->				
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_9"><span class="dashicons dashicons-admin-home" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Measurement <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (10) Access -->				
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_10"><span title="list of access restrictions for information contained within this entry" class="dashicons dashicons-groups" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Access <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (11) Legal -->				
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_11"><span title="Description of the significance of this entry in accordance with UNESCO, ICOMOS, CIDOC CRM, MIDAS Heritage and SEWPAC" class="dashicons dashicons-awards" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Legal <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (12) Available Media -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_12"><span title="shows the number of available media formats - please also see gallery browser on the left of this window" class="dashicons dashicons-admin-media" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Available Media Formats <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (13) Contact -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_13"><span title="address and contact person or company for this entry" class="dashicons dashicons-admin-users" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Contact <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- Media Gallery -->	
				<div style="width: 140px; height: 100vh; float: left; background-color:rgba(160,0,0, 0.3); overflow: scroll;">
