...
if (in_category('cat-00-01')) {
		include (STYLESHEETPATH.'/single-resources.php');
		return;
}
		
if (in_category('cat-00-02')) {
		include (STYLESHEETPATH.'/single-wikipedia.php');
		return;
}
...
if (in_category('cat-01-02')) {
		include (STYLESHEETPATH.'/single-projects.php');
		return;	
}
		
if (in_category('cat-01-03')) {
		include (STYLESHEETPATH.'/single-places.php');
		return;
}
		
if (in_category('cat-01-04')) {
		include (STYLESHEETPATH.'/single-sites.php');
		return;
}
		
if (in_category('cat-01-05')) {
		include (STYLESHEETPATH.'/single-items.php');
		return;
