										...
										<?php if (get_field('RAE_0208_r')): ?><?php $counter = 1; ?>
															...
															<?php while(has_sub_field('RAE_0208_r')): ?>
																<div class="custom-div-bg_1">																	
																	<div id="media-gallery-background"><a class="lightbox" title="<strong><?php the_sub_field('RAE_0210')?>:</strong> <?php the_sub_field('RAE_0211')?>" href="http://www.rockartdatabase.com/v2/wp-content/themes/v2/plugin_x3dom_images/index.html?img=<?php the_sub_field('RAE_0209')?>"><img class="media-gallery" src="<?php the_sub_field('RAE_0209')?>"></a>
																	</div>																	
