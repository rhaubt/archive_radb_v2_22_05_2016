...
<!-- (6) Location (other collections) -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_6"><span class="dashicons dashicons-admin-site" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Locations (<?php $count = (count(get_field('RAE_0119'))+count(get_field('RAE_0120'))+count(get_field('RAE_0121'))+count(get_field('RAE_0122'))+count(get_field('RAE_0123'))+count(get_field('RAE_0124'))); ?><?php echo $count ?> collections) <span style="float:right; padding-right:5px;">&#9660</span></label>
