...
<!-- Feature Image Thumbnail and Lightbox -->				
					...
					$height = $image['sizes'][ $size_large . '-height' ];
 					?>
					<a title="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><img style="border-radius: 5px;" src="<?php echo $thumb; ?>" alt="no image"></a>
					</td>
<!--     color label  -->
...
<!--     condition  -->						
						<p class="custom_small-font">Condition: <?php the_field('RAE_0082'); ?></br></p></br>
<!--     author  -->						
...
<!-- Show Own Relationship Field Selections -->									
							...
							<tr>
								<td class="custom-td-bg_1">
									...
									<p style="text-align:center;">This Place</p>
									<p style="text-align:center;">|</p>
...
<!-- (6) Collection Location (other collections within this archives) -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_6"><span class="dashicons dashicons-archive" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Collection Locations (<?php $count = (count(get_field('RAE_0119'))+count(get_field('RAE_0120'))+count(get_field('RAE_0121'))+count(get_field('RAE_0122'))+count(get_field('RAE_0123'))+count(get_field('RAE_0124'))); ?><?php echo $count ?> other associated countries) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (13) References -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_13"><span class="dashicons dashicons-book-alt" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> References <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- images - using object acf - send url= & h=echo ($height / 100)."\n" and w=echo ($width / 100)."\n" to href link - devide by 100 to adjust screen size and ratio -->
					...
					<div class="custom-media-image">				
						...
						<div class="custom-div-bg_1">								
							<?php if( $link ): ?>													 				
								<div id="media-gallery-background"><a class="lightbox" title="<strong><?php the_sub_field('RAE_0210')?>:</strong> <?php the_sub_field('RAE_0211')?>" href="http://www.rockartdatabase.com/v2/wp-content/themes/v2/plugin_x3dom_images/index.html?img=<?php echo $image['sizes']['large']; ?>&w=<?php echo ($width / 100)."\n"; ?>&h=<?php echo ($height / 100)."\n"; ?>"><img class="media-gallery" src="<?php echo $thumb; ?>" /></a>
								</div>
