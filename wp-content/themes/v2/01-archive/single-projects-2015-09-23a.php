...
<!--     wti like / body content  -->						
						<div class="storycontent" style="height: 21px; max-width: 437px; padding:0px 2px 5px 0px; font-size:14px; margin-left: -163px;">
							...
							<a href="<?php the_field('RAE_0231'); ?>"><span class="dashicons dashicons-facebook" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span></a>
							<?php endif; ?>
							<?php if (get_field('RAE_0232')): ?>
							<a href="<?php the_field('RAE_0231'); ?>"><span class="dashicons dashicons-twitter" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span></a>
							<?php endif; ?>
							<?php if (get_field('RAE_0233')): ?>
							<a href="<?php the_field('RAE_0231'); ?>"><span class="dashicons dashicons dashicons-share-alt" style="position: relative; top: 0px; left: 0px; z-index: 5;"></span></a>
							<?php endif; ?>					
						</div>
					</td>
				</table>
...
<!-- Show Own Relationship Field Selections -->									
							...
							<tr>
								<td class="custom-td-bg_1">
									<p style="text-align:center;">This Project</p>
...
<!-- (7) Collection Location (other collections within this archives) -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_7"><span class="dashicons dashicons-archive" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Collection Locations (<?php $count = (count(get_field('RAE_0118'))); ?><?php echo $count ?> continents) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (8) classification archaeology -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_8"><span class="dashicons dashicons-clipboard" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Classification (Archaeology) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (9) classification rock art -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_9"><span class="dashicons dashicons-universal-access-alt" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Classification (Rock Art) <span style="float:right; padding-right:5px;">&#9660</span></label>
