...
<!-- (3) Location -->	
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_3"><span title="the geolocation of this record including address and or location approach descriptions" class="dashicons dashicons-location-alt" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Location <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (4) Collection Location (other collections within this archives) -->
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_4"><span title="all continents, countries, regions or language group areas contained within this entry (if the entry is a place, site or item the location usually only contains one continent, country or region)" class="dashicons dashicons-archive" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Collection Locations (<?php $count = (count(get_field('RAE_0118'))); ?><?php echo $count ?> continents) <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- (5) Collection -->				
		<label style="text-align:left; background-color:#282828; border: solid 1px #e0e0e0; padding: 10px 0px 2px 7px; color:#e0e0e0;" class="collapse" for="_5"><span title="contains all projects, places, sites, items and news related to this record" class="dashicons dashicons-archive" style="position: relative; top: -5px; left: 0px; z-index: 5;"></span> Collection <span style="float:right; padding-right:5px;">&#9660</span></label>
...
<!-- Media Gallery -->	
				<div style="width: 140px; height: 100vh; float: left; background-color:rgba(0,255,0, 0.3); overflow: scroll;">
